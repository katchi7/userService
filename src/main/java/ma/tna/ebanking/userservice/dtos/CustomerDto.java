...
public class CustomerDto {
    ...
    public CustomerDto(Customer customer){
        this(
                ...
                customer.getConseille(),customer.getSector()
        );
    ...
    public Customer asCustomer(){
        ...
        ,gender,agency,agencyName,residence,restrictionValue,primaryProfil,profiles,primaryProfileAccounts.stream().map(AccountDto::asAccount).collect(Collectors.toList()),conseille,sector);
    }
}
