...
public class CustomerDto {
    ...
    public Customer asCustomer(){
        ...
        ,gender,agency,agencyName,residence,restrictionValue,primaryProfil,profiles,primaryProfileAccounts.stream().map(AccountDto::asAccount).collect(Collectors.toList()),conseille);
    }
}
